...
import {LoadingSkeleton, TableSkeleton} from "../index.jsx";
const CustomerUserTable = ({ customers, currentPage, totalPages, onPageChange  }) => {
    ...
    const opendHistoryOrderCustomer = (customerId) =>{
        navigate(`/customer/historyOrder/${customerId}`);
    }
    if (loadingCustomer) return <div>
        <TableSkeleton/>
    </div>;
