...
const CategoryTable = ({ categories, currentPage, totalPages, onPageChange ,fetchCategory ,categoriesPerPage , searchTerm }) => {
                    ...
                    {categories.length > 0 ? (
                        categories.map((category, index) => (
                            <tr key={index} className="hover:bg-gray-50 border-b">
                                ...
                                <td className="py-3 px-5 flex justify-center gap-2 p-2">
