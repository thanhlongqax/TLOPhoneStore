...
import {notifyAddCategory, notifyCategoryMessage} from "../../../../utils";
...
function AddCategory() {
    ...
    const { loadingCategory , errorCategory , createCategory } = useCategoryHook();
    ...
    const handleSubmit = async (e) => {
        ...
        const respone = await createCategory(Category)
        if(respone.statusCode === STATUS_CODES.BAD_REQUEST.code){
            notifyCategoryMessage(`Vui lòng nhập lại,${respone.message }`);
        }
            ...
            <div className="container mx-auto px-4">
                <div className="flex items-center px-12 py-12 sm:px-12  sm:py-12  rounded-md">
                    <nav aria-label="Breadcrumb" className="flex space-x-2">
                        ...
                        <span className="text-gray-400">/</span>
                        <span className="text-gray-900 text-sm font-semibold">Thêm danh mục</span>
                    </nav>
                </div>

                <h2 className="text-2xl font-semibold text-center text-gray-900 mb-4">Thêm danh mục</h2>
                ...
                <form className="px-12 py-12 pb-12 mb-12 mt-8 sm:px-12  sm:py-12  bg-white shadow-lg rounded-lg" onSubmit={handleSubmit}>
                    <div className="space-y-12">
                        <div className="border-b border-gray-900/10 pb-12">
                            <h2 className="text-base/7 font-semibold text-gray-900">Thêm danh mục </h2>
                            <p className="mt-1 text-sm/6 text-gray-600">
                                Vui lòng nhập thông tin về thêm danh mục mới
                            </p>
