import {Search, CategoryUserTable,} from '../../components/index.jsx';
import { useCategoryHook } from '../../hook';
import {useEffect, useState} from "react";
function CategoryUserPage() {
    const { categories , fetchCategories ,totalCatogories , errorCategory } = useCategoryHook();
...
export default CategoryUserPage;
